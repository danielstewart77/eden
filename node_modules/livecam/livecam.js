...
function GstLaunch() {
	...
	const gst_launch_executable = 'gst-launch';
	//const gst_launch_executable = 'gst-launch-0.10';
	...
	var isAvailable = function() {
		//console.log('gst version: ' + getVersion());
...
function GstLiveCamServer(config) {
	...
	var start = function(tcp_addr, tcp_port) {
		...
		//const cam_pipeline = 'v4l2src ! decodebin ! jpegenc ! flvmux ! filesink location=/home/daniel/video/cam.flv';

		//const cam_pipeline = 'v4l2src device=/dev/video0 ! video/x-raw-yuv,width=320,height=240 ! mfw_ipucsc ! jpegenc ! filesink location=/home/daniel/video/cam.jpeg'

		const cam_pipeline = 'v4l2src device=/dev/video0 ! video/x-raw-yuv,width=320,height=240 ! jpegenc ! filesink location=/home/daniel/video/cam.jpeg'
...
function LiveCam(config) {
	...
	const gst_tcp_addr = config.gst_addr || "192.168.0.28";
	const gst_tcp_port = config.gst_port || 10000;
	const ui_addr = config.ui_addr || "192.168.0.28";
	const ui_port = config.ui_port || 11000;
	const broadcast_addr = config.broadcast_addr || "192.168.0.28";
